...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        //非必要情况，不建议使用，第三方的开源库，使用通知显示当前请求的log，
        // 不过在做文件下载的时候，这个库好像有问题，对文件判断不准确
...
//        builder.hostnameVerifier(new SafeHostnameVerifier());
        ...
        //key=1186ca08b861129b0dbf58bdd2a00cd8
        params.put("key", "1186ca08b861129b0dbf58bdd2a00cd8");     //param支持中文,直接传,不要自己编码
